import { _ as _export_sfc, s as serverRenderer_cjs_prodExports, v as vueExports, u as useRouter$1, a as useNuxtApp, r as resolveRouteObject, b as useRuntimeConfig, n as navigateTo, c as nuxtLinkDefaults } from './server.mjs';
import { J as parseQuery, p as hasProtocol, o as joinURL, K as withTrailingSlash, L as withoutTrailingSlash } from '../_/nitro.mjs';
import { u as useHead } from './composables-DqoaiqVk.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-ef242cd1><div class="max-w-520px text-center" data-v-ef242cd1><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-ef242cd1>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.statusCode)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-ef242cd1>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.statusMessage)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-ef242cd1>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-ef242cd1>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@4.1.3_@parcel+watcher@_5e8508ab136d2ec7a35859f69c793ae1/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ef242cd1"]]);

export { error404 as default };
//# sourceMappingURL=error-404-DNXI9xT7.mjs.map
